...
|------------- | ------------- | -------------|
|[**resultControllerDeleteResult**](#resultcontrollerdeleteresult) | **DELETE** /result | |
...
const { status, data } = await apiInstance.resultControllerDeleteResult(
    projectId,
    buildId,
    screenName,
    projectType
