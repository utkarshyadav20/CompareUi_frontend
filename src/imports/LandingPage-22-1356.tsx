import svgPaths from "./svg-blq9nhwfbu";
...
function Frame29() {
  return (
    <div className="bg-[rgba(255,255,255,0.05)] relative rounded-[8px] shrink-0 w-full">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[2px] items-center justify-center p-[6px] relative w-full">
          <Frame39 />
  ...
  return (
    <div className="bg-[rgba(255,255,255,0.05)] relative rounded-[8px] shrink-0 w-full">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[4px] items-start justify-center p-[6px] relative w-full">
          <Frame52 />
          <Container />
        </div>
      </div>
...
function Frame27() {
  return (
    <div className="content-stretch flex flex-col gap-[9px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full">
      ...
      <p className="font-['DM_Mono:Regular',sans-serif] min-w-full relative shrink-0 text-[14px] w-[min-content]">Upload another image</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-[#191919] h-[749px] relative shrink-0 w-full">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[10px] items-center px-[20px] py-[11px] relative size-full">
          <Frame29 />
          <Frame53 />
          <Frame45 />
