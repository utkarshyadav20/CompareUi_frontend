import svgPaths from "./svg-j0b7hl7z8d";
...
function Frame49() {
  return (
    <div className="bg-[rgba(255,255,255,0.15)] content-stretch flex flex-col items-center justify-center relative rounded-[3px] shrink-0 size-[16px]">
...
function Frame39() {
  return (
    <div className="bg-[#191919] h-[749px] relative shrink-0 w-full">
...
function Frame25() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] h-full relative shrink-0 w-[335px]">
      <div className="content-stretch flex flex-col gap-[20px] items-center overflow-clip px-0 py-[20px] relative rounded-[inherit] size-full">
        <Frame40 />
        <Frame39 />
      </div>
