import svgPaths from "./svg-xptq7rjsig";
...
function Frame1() {
  return (
    <div className="h-full relative rounded-[8px] shrink-0 w-[381px]">
...
function Frame31() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] content-stretch flex items-center justify-center p-[10px] relative rounded-[4px] shrink-0">
      ...
      <p className="font-['DM_Mono:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-nowrap text-white">Pixelmatch</p>
    </div>
  );
}
...
function Frame33() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center p-[10px] relative rounded-[4px] shrink-0">
      ...
      <p className="font-['DM_Mono:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#6bdf95] text-[14px] text-nowrap">{`Noise `}</p>
    </div>
  );
}
...
function Frame40() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center p-[10px] relative rounded-[4px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[rgba(107,223,149,0.3)] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="font-['DM_Mono:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#6bdf95] text-[14px] text-nowrap">Yes</p>
    </div>
  );
}
...
function Frame41() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] content-stretch flex items-center justify-center p-[10px] relative rounded-[4px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.1)] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="font-['DM_Mono:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-nowrap text-white">No</p>
    </div>
  );
}
...
function Frame43() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] content-stretch flex flex-col items-center justify-center p-[10px] relative rounded-[4px] shrink-0 w-[38px]">
      <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.1)] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="font-['DM_Mono:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-white w-full">1x</p>
    </div>
  );
}
...
function Frame32() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] content-stretch flex flex-col items-center justify-center p-[10px] relative rounded-[4px] shrink-0 w-[38px]">
      <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.1)] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="font-['DM_Mono:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-white w-full">2x</p>
    </div>
  );
}
...
function Frame47() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center p-[10px] relative rounded-[4px] shrink-0 w-[38px]">
      <div aria-hidden="true" className="absolute border border-[rgba(107,223,149,0.3)] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="font-['DM_Mono:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#6bdf95] text-[14px] w-full">3x</p>
    </div>
  );
}
...
function Frame48() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] content-stretch flex flex-col items-center justify-center p-[10px] relative rounded-[4px] shrink-0 w-[38px]">
      <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.1)] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="font-['DM_Mono:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-white w-full">4x</p>
    </div>
  );
}
...
function Frame35() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] content-stretch flex flex-col items-center justify-center p-[10px] relative rounded-[4px] shrink-0 w-[38px]">
      <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.1)] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="font-['DM_Mono:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-white w-full">5x</p>
    </div>
  );
}
  ...
  return (
    <div className="basis-0 bg-[rgba(255,255,255,0.05)] grow min-h-px min-w-px relative rounded-[8px] shrink-0">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[20px] py-[14px] relative w-full">
          <p className="font-['DM_Sans:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[16px] text-[rgba(255,255,255,0.5)] text-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
            Enter URL here
          </p>
        </div>
...
function Frame29() {
  return (
    <div className="content-stretch flex flex-col gap-[9px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full">
      <p className="font-['Font_Awesome_6_Pro:Solid',sans-serif] relative shrink-0 text-[20px] text-nowrap">File-upload</p>
      <p className="font-['DM_Mono:Regular',sans-serif] min-w-full relative shrink-0 text-[14px] w-[min-content]">Click here to upload CSV File with multiple screen link</p>
    </div>
  );
}
...
function Frame25() {
  return (
    <div className="bg-[rgba(255,255,255,0.05)] relative rounded-[10px] shrink-0 w-full">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start px-[78px] py-[87px] relative w-full">
          <Frame29 />
        </div>
      </div>
...
function Frame51() {
  return (
    <div className="content-stretch flex flex-col gap-[9px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full">
      <p className="font-['Font_Awesome_6_Pro:Solid',sans-serif] relative shrink-0 text-[20px] text-nowrap">File-upload</p>
      <p className="font-['DM_Mono:Regular',sans-serif] min-w-full relative shrink-0 text-[14px] w-[min-content]">Upload image</p>
    </div>
  );
}
...
function Frame45() {
  return (
    <div className="bg-[rgba(255,255,255,0.05)] h-[88px] relative rounded-[10px] shrink-0 w-full">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
  ...
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative">
        <p className="font-['Consolas:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#05df72] text-[16px] text-nowrap">Sim Connected</p>
      </div>
    </div>
  );
}
...
function Container1() {
  return (
    <div className="bg-[rgba(3,46,21,0.5)] content-stretch flex gap-[8px] h-[32px] items-center px-[8px] py-0 relative rounded-[4px] shrink-0" data-name="Container">
      <Container />
      <Text />
    </div>
  );
...
function Frame52() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] content-stretch flex gap-[10px] items-center justify-center leading-[normal] not-italic p-[10px] relative rounded-[4px] shrink-0 text-[14px] text-nowrap text-white">
      <p className="font-['Font_Awesome_6_Pro:Regular',sans-serif] relative shrink-0">rotate</p>
      <p className="font-['DM_Mono:Medium',sans-serif] relative shrink-0">Fetch</p>
    </div>
  );
}
...
function Frame57() {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center p-[10px] relative rounded-[4px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[rgba(107,223,149,0.3)] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="font-['DM_Mono:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#6bdf95] text-[14px] text-nowrap">Chrome</p>
...
function Container2() {
  return (
    <div className="bg-[rgba(251,44,54,0.5)] relative rounded-[2.68435e+07px] shrink-0 size-[12px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid size-full" />
    </div>
  );
}
...
function Container3() {
  return (
    <div className="bg-[rgba(240,177,0,0.5)] relative rounded-[2.68435e+07px] shrink-0 size-[12px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid size-full" />
    </div>
  );
}
...
function Container4() {
  return (
    <div className="basis-0 bg-[rgba(0,201,80,0.5)] grow h-[12px] min-h-px min-w-px relative rounded-[2.68435e+07px] shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid size-full" />
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="basis-0 bg-[rgba(255,255,255,0.05)] grow h-full min-h-px min-w-px relative rounded-[4px] shrink-0">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[10px] items-center leading-[normal] px-[10px] py-[14px] relative size-full text-[rgba(255,255,255,0.5)] text-nowrap">
          <p className="font-['Font_Awesome_6_Pro:Regular',sans-serif] not-italic relative shrink-0 text-[18px]">globe</p>
          <p className="font-['DM_Sans:Regular',sans-serif] font-normal relative shrink-0 text-[14px] tracking-[-0.14px]" style={{ fontVariationSettings: "'opsz' 14" }}>
            DAV
          </p>
        </div>
      </div>
  ...
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="Icon">
          <path d={svgPaths.p16288500} id="Vector" stroke="var(--stroke-0, #9F9FA9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" style={{ stroke: "color(display-p3 0.6235 0.6235 0.6627)", strokeOpacity: "1" }} />
          <path d="M12.25 1.75V4.66667H9.33333" id="Vector_2" stroke="var(--stroke-0, #9F9FA9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" style={{ stroke: "color(display-p3 0.6235 0.6235 0.6627)", strokeOpacity: "1" }} />
        </g>
      </svg>
    </div>
  );
...
function Button() {
  return (
    <div className="bg-[#27272a] h-full relative rounded-[4px] shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex h-full items-center px-[12px] py-0 relative">
        <Icon />
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[48px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 48">
        <g id="Icon">
          <path d={svgPaths.p1f337080} id="Vector" stroke="var(--stroke-0, #F0B100)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" style={{ stroke: "color(display-p3 0.9412 0.6941 0.0000)", strokeOpacity: "1" }} />
          <path d={svgPaths.p1ae0c400} id="Vector_2" stroke="var(--stroke-0, #F0B100)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" style={{ stroke: "color(display-p3 0.9412 0.6941 0.0000)", strokeOpacity: "1" }} />
          <path d="M4 24H44" id="Vector_3" stroke="var(--stroke-0, #F0B100)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" style={{ stroke: "color(display-p3 0.9412 0.6941 0.0000)", strokeOpacity: "1" }} />
        </g>
      </svg>
    </div>
  );
...
function Container7() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center relative shrink-0 w-full" data-name="Container">
      <Icon1 />
      <p className="font-['Consolas:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#fdc700] text-[16px] text-center text-nowrap">Invalid URL</p>
      <p className="font-['Consolas:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#71717b] text-[16px] text-center w-[432px]">Please enter a valid URL starting with http:// or https://</p>
    </div>
  );
}
...
function Container8() {
  return (
    <div className="basis-0 bg-[rgba(24,24,27,0.5)] grow min-h-px min-w-px relative rounded-[4px] shrink-0 w-full" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start pb-[0.8px] pt-[178px] px-[0.8px] relative size-full">
          <Container7 />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#3f3f46] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[4px]" />
    </div>
  );
}
...
function Container9() {
  return (
    <div className="basis-0 bg-[#09090b] grow min-h-px min-w-px relative rounded-[10px] shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#27272a] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[10px]" />
