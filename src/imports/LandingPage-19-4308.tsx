import svgPaths from "./svg-2fsy62riyy";
import imgFrame21 from "figma:asset/4162ceeb80530f8f205313a378469f2d23a67359.png";
import imgImage1208 from "figma:asset/87e2aa4f6e8f3d30c8d0c5813685bf9d9f0dc96b.png";
import imgImage1209 from "figma:asset/35fff3c95149e08d3578a0bb6524c93ac858ad0c.png";
...
function Frame43() {
  return (
    <div className="aspect-[12/12] content-stretch flex flex-col h-full items-center justify-center relative rounded-[3px] shrink-0">
      <p className="font-['Font_Awesome_6_Pro:Regular',sans-serif] leading-[5px] not-italic relative shrink-0 text-[16px] text-[red] text-nowrap tracking-[-1.12px]">TRASH-XMARK</p>
    </div>
  );
}
...
function Frame46() {
  return (
    <div className="bg-[rgba(255,255,255,0.05)] relative rounded-[8px] shrink-0 w-[622px]">
      <div className="content-stretch flex flex-col gap-[2px] items-center justify-center overflow-clip p-[6px] relative rounded-[inherit] w-full">
        <Frame45 />
        <div className="aspect-[1920/1080] relative rounded-[3px] shrink-0 w-full" data-name="image 1208">
          <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[3px] size-full" src={imgImage1209} />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[0.5px] border-[rgba(255,255,255,0.2)] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
