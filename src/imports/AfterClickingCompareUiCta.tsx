import svgPaths from "./svg-3rt7get1at";
...
function Frame19() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] content-stretch flex flex-col items-center justify-center p-[8.28px] relative rounded-[3.312px] shrink-0">
      <p className="font-['Font_Awesome_6_Pro:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14.903px] text-[rgba(255,255,255,0.5)] w-full">grid-2</p>
    </div>
  );
}
...
function Frame20() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center p-[8.28px] relative shrink-0">
      <p className="font-['Font_Awesome_6_Pro:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14.903px] text-[rgba(255,255,255,0.5)] w-full">list</p>
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="h-[41px] relative rounded-[6.624px] shrink-0 w-[72.818px]">
      ...
      <div aria-hidden="true" className="absolute border-[0.828px] border-[rgba(255,255,255,0.5)] border-solid inset-0 pointer-events-none rounded-[6.624px]" />
    </div>
  );
}
...
function Frame21() {
  return (
    <div className="bg-white content-stretch flex gap-[9.075px] items-center justify-center leading-[normal] overflow-clip px-[16px] py-[11.798px] relative rounded-[7.26px] shrink-0 text-[#0e0e0e] text-[14px] text-nowrap">
      <p className="font-['Font_Awesome_6_Pro:Solid',sans-serif] not-italic relative shrink-0">star-christmas</p>
...
function Frame9() {
  return (
    <div className="basis-0 bg-[rgba(255,255,255,0.05)] grow h-full min-h-px min-w-px relative rounded-[8px] shrink-0">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[20px] py-[14px] relative size-full">
          <p className="font-['DM_Sans:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[14px] text-[rgba(255,255,255,0.5)] text-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
            Enter More URL here
          </p>
        </div>
      </div>
...
function Frame22() {
  return (
    <div className="bg-white content-stretch flex h-full items-center justify-center overflow-clip px-[16px] py-[13px] relative rounded-[8px] shrink-0 w-[35px]">
      <p className="font-['Font_Awesome_6_Pro:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#0e0e0e] text-[14px] text-nowrap">arrow-right</p>
    </div>
  );
}
...
function Frame28() {
  return (
    <div className="content-stretch flex gap-[5px] h-[35px] items-start relative shrink-0 w-full">
      <Frame9 />
      <Frame22 />
    </div>
  );
...
function Frame29() {
  return (
    <div className="bg-[rgba(255,255,255,0.05)] relative rounded-[8px] shrink-0 w-[275px]">
      <div className="content-stretch flex flex-col gap-[2px] items-center justify-center overflow-clip p-[6px] relative rounded-[inherit] w-full">
        <Frame39 />
...
function Frame53() {
  return (
    <div className="bg-[rgba(255,255,255,0.15)] relative rounded-[8px] shrink-0 w-[275px]">
      <div className="content-stretch flex flex-col gap-[4px] items-start justify-center overflow-clip p-[6px] relative rounded-[inherit] w-full">
        <Frame52 />
        <Container />
      </div>
      <div aria-hidden="true" className="absolute border-[0.5px] border-[rgba(255,255,255,0.5)] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
}
...
function Frame40() {
  return (
    <div className="bg-[#191919] relative shrink-0 w-[315px]">
      <div className="content-stretch flex flex-col gap-[10px] items-center overflow-clip px-0 py-[11px] relative rounded-[inherit] w-full">
        <Frame29 />
        <Frame51 />
        <Frame53 />
        <Frame56 />
        <Frame58 />
        <div className="absolute bg-[rgba(217,217,217,0.3)] h-[96.203px] right-0 rounded-[20px] top-[11px] w-[9.165px]" />
      </div>
      <div className="absolute inset-0 pointer-events-none shadow-[inset_0px_8px_41px_-13px_rgba(255,255,255,0.1)]" />
...
function Frame26() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] h-full relative shrink-0 w-[315px]">
...
function Frame62() {
  return (
    <div className="bg-[rgba(255,255,255,0.05)] h-[204.68px] max-h-[204.6798858642578px] max-w-[316.3299865722656px] min-h-[168.23182678222656px] min-w-[260px] relative rounded-[8px] shrink-0 w-[316.33px]">
      <div className="content-stretch flex flex-col gap-[2px] items-center justify-center max-h-[inherit] max-w-[inherit] min-h-[inherit] min-w-[inherit] overflow-clip p-[6px] relative rounded-[inherit] size-full">
        <Frame61 />
        <div className="aspect-[1920/1080] relative rounded-[3px] shrink-0 w-full" data-name="image 1208">
          <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[3px] size-full" src={imgImage1208} />
        </div>
...
function DebugAltSmallSvgrepoCom() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="debug-alt-small_svgrepo.com">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_22_534)" id="debug-alt-small_svgrepo.com">
          <path d={svgPaths.p3b7a7a00} fill="var(--fill-0, #8B7CAD)" id="Vector" style={{ fill: "color(display-p3 0.5439 0.4857 0.6798)", fillOpacity: "1" }} />
          <path clipRule="evenodd" d={svgPaths.p3c421700} fill="var(--fill-0, #8B7CAD)" fillRule="evenodd" id="Vector_2" style={{ fill: "color(display-p3 0.5439 0.4857 0.6798)", fillOpacity: "1" }} />
        </g>
        <defs>
...
function Frame65() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] items-start leading-[normal] relative shrink-0 w-full">
      <p className="font-['DM_Sans:Bold',sans-serif] font-bold relative shrink-0 text-[#f6f6f6] text-[16px] w-full" style={{ fontVariationSettings: "'opsz' 14" }}>
        Ui comparison started
      </p>
      <p className="-webkit-box font-['Inter_Variable:Regular',sans-serif] font-normal overflow-ellipsis overflow-hidden relative shrink-0 text-[13px] text-[rgba(246,246,246,0.5)] w-full">New test generated and running in background to view click on below cta</p>
    </div>
  );
}
...
function Frame66() {
  return (
    <div className="content-stretch flex items-center justify-between leading-[normal] relative shrink-0 text-[12px] text-nowrap w-full">
      <p className="font-['DM_Sans:SemiBold',sans-serif] font-semibold relative shrink-0 text-[#f6f6f6]" style={{ fontVariationSettings: "'opsz' 14" }}>
        View full report
      </p>
      <p className="font-['DM_Sans:Regular',sans-serif] font-normal relative shrink-0 text-[rgba(255,255,255,0.5)]" style={{ fontVariationSettings: "'opsz' 14" }}>
        Just Now
      </p>
    </div>
  );
...
function Frame67() {
  return (
    <div className="content-stretch flex flex-col h-full items-start justify-between relative shrink-0 w-[230px]">
      <Frame65 />
      <Frame66 />
    </div>
  );
...
function Frame68() {
  return (
    <div className="absolute bg-[#3e3e3e] bottom-[34px] content-stretch flex gap-[8px] h-[113px] items-start p-[10px] right-[23px] rounded-[6px]">
      <div aria-hidden="true" className="absolute border-[0.6px] border-[rgba(255,255,255,0.3)] border-solid inset-0 pointer-events-none rounded-[6px] shadow-[0px_4px_20px_0px_rgba(0,0,0,0.5)]" />
      <Frame64 />
      <Frame67 />
      <p className="font-['Font_Awesome_6_Pro:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-[rgba(246,246,246,0.5)] text-nowrap">xmark</p>
    </div>
  );
}

export default function AfterClickingCompareUiCta() {
  return (
    <div className="bg-black content-stretch flex flex-col gap-[2px] items-start relative size-full" data-name="after clicking compare ui cta">
      <Frame16 />
      <Frame30 />
      <Frame25 />
      <Frame68 />
