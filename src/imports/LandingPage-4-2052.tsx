import svgPaths from "./svg-3ouryjo6a4";
...
function Frame31() {
  return (
    <div className="relative rounded-[8px] shrink-0 w-[275px]">
...
function Frame42() {
  return (
    <div className="bg-[#191919] h-[749px] relative shrink-0 w-[323px]">
      <div className="content-stretch flex flex-col gap-[10px] items-center overflow-clip px-0 py-[11px] relative rounded-[inherit] size-full">
        <Frame31 />
        <Frame51 />
      </div>
      <div className="absolute inset-0 pointer-events-none shadow-[inset_0px_8px_41px_0px_rgba(255,255,255,0.1)]" />
...
function Frame28() {
  return (
    <div className="content-stretch flex flex-col font-['DM_Mono:Regular',sans-serif] gap-[25px] items-center leading-[normal] not-italic relative shrink-0 text-[18px] text-center w-full">
      <p className="relative shrink-0 text-white w-full">Receiving....</p>
      <p className="relative shrink-0 text-[rgba(255,255,255,0.5)] w-full">
...
function Frame29() {
  return (
    <div className="content-stretch flex gap-[11px] items-center leading-[normal] relative shrink-0 text-[18px] text-white">
      <p className="font-['Font_Awesome_6_Pro:Light',sans-serif] not-italic relative shrink-0 w-[18px]">rotate</p>
