import svgPaths from "./svg-7wgdmt7i2t";
...
export default function FromFloderAllImagesAreLoaded() {
  return (
    <div className="bg-black content-stretch flex flex-col gap-[2px] items-start relative size-full" data-name="from floder all images are loaded">
      <Frame16 />
      <Frame30 />
      <Frame25 />
    </div>
