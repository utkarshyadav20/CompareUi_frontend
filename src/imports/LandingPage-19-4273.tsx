import svgPaths from "./svg-ra30v45ies";
...
function Frame43() {
  return (
    <div className="content-stretch flex gap-[19px] items-center overflow-clip px-0 py-[5px] relative shrink-0 w-[617.325px]">
      <div className="basis-0 flex flex-row grow items-center self-stretch shrink-0">
        <div className="basis-0 grow h-full min-h-px min-w-px relative shrink-0">
          <div className="absolute inset-[-1px_0_0_0]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 282 1">
              <line id="Line 340" stroke="var(--stroke-0, white)" strokeDasharray="6 6" strokeOpacity="0.2" style={{ stroke: "white", strokeOpacity: "0.2" }} x2="281.163" y1="0.5" y2="0.5" />
            </svg>
          </div>
        </div>
      </div>
...
function Frame49() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full">
      <p className="font-['Font_Awesome_6_Pro:Solid',sans-serif] relative shrink-0 text-[20px] text-nowrap">image</p>
      <p className="font-['DM_Mono:Regular',sans-serif] min-w-full relative shrink-0 text-[14px] w-[min-content]">Upload image from Local Device</p>
    </div>
  );
}
...
function Frame26() {
  return (
    <div className="bg-[rgba(255,255,255,0.05)] h-[207px] relative rounded-[10px] shrink-0 w-full">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        ...
        <div className="basis-0 grow h-full min-h-px min-w-px relative shrink-0">
          <div className="absolute inset-[-1px_0_0_0]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 284 1">
              <line id="Line 340" stroke="var(--stroke-0, white)" strokeDasharray="6 6" strokeOpacity="0.2" style={{ stroke: "white", strokeOpacity: "0.2" }} x2="283.5" y1="0.5" y2="0.5" />
            </svg>
          </div>
        </div>
      </div>
    ...
    <div className="basis-0 bg-[rgba(255,255,255,0.1)] grow h-full min-h-px min-w-px relative shrink-0">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[20px] items-center p-[20px] relative size-full">
          <p className="font-['DM_Sans:Bold',sans-serif] font-bold leading-[normal] min-w-full relative shrink-0 text-[20px] text-white w-[min-content]" style={{ fontVariationSettings: "'opsz' 14" }}>
            Baselining Images
          </p>
          <Frame28 />
          <Frame43 />
...
function Frame51() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center leading-[normal] not-italic relative shrink-0 text-center text-white w-full">
      <p className="font-['Font_Awesome_6_Pro:Solid',sans-serif] relative shrink-0 text-[20px] text-nowrap">image</p>
      <p className="font-['DM_Mono:Regular',sans-serif] min-w-full relative shrink-0 text-[14px] w-[min-content]">Upload Screenshot from Local Device</p>
    </div>
  );
}
...
function Frame52() {
  return (
    <div className="basis-0 bg-[rgba(255,255,255,0.05)] grow min-h-px min-w-px relative rounded-[10px] shrink-0 w-full">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center justify-center p-[10px] relative size-full">
          <Frame51 />
        </div>
