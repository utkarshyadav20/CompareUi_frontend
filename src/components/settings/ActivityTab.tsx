  ...
  return (
    <div className="flex-1 px-[32px] py-[24px] overflow-auto bg-background">
      <div className="max-w-[1400px]">
        <div className="mb-6">
          <h2 className="text-foreground text-[20px] font-bold">
            Activity Log
          </h2>
        </div>
        ...
        <div className="space-y-[1px]">
          {activityLogs.map((log) => (
            <div
              key={log.id}
              className="flex items-center gap-4 px-4 py-3 bg-muted/40 hover:bg-muted/60 transition-colors border-l-2 border-transparent hover:border-primary/20"
            >
              {/* Icon */}
