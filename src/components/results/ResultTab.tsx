  ...
  const allTests: TestCase[] = [
    {
      ...
      sNo: 1,
      testName: "HomeScreen",
      timestamp: "12/1/2025 at 7:28 PM",
      status: "PASS",
      mismatchPercent: "33.33%",
      duration: "8m 12 sec",
    },
    {
      id: "2",
      sNo: 2,
      testName: "ProfilePage",
      timestamp: "12/1/2025 at 7:45 PM",
      status: "PASS",
      mismatchPercent: "20.00%",
      duration: "10m 5 sec",
    },
    {
      id: "3",
      sNo: 3,
      testName: "Settings",
      timestamp: "12/1/2025 at 8:00 PM",
      status: "FAIL",
      mismatchPercent: "75.00%",
      duration: "5m 30 sec",
    },
    {
      id: "4",
      ...
      timestamp: "12/1/2025 at 8:15 PM",
      status: "FAIL",
      mismatchPercent: "50.00%",
      duration: "4m 45 sec",
    },
    {
      id: "5",
      sNo: 5,
      testName: "Messages",
      timestamp: "12/1/2025 at 8:30 PM",
      status: "PASS",
      mismatchPercent: "30.00%",
      duration: "3m 20 sec",
    },
    {
      id: "6",
      sNo: 6,
      testName: "Dashboard",
      timestamp: "12/1/2025 at 8:45 PM",
      status: "FAIL",
      mismatchPercent: "90.00%",
      duration: "2m 15 sec",
    },
    {
      id: "7",
      sNo: 7,
      testName: "HelpCenter",
      timestamp: "12/1/2025 at 9:00 PM",
      status: "FAIL",
      mismatchPercent: "65.00%",
      duration: "6m 5 sec",
    },
    {
      id: "8",
      sNo: 8,
      testName: "AboutUs",
      timestamp: "12/1/2025 at 9:15 PM",
      status: "PASS",
      mismatchPercent: "10.00%",
      duration: "8m 50 sec",
    },
    {
      id: "9",
      sNo: 9,
      testName: "TermsOfService",
      timestamp: "12/1/2025 at 9:30 PM",
      status: "Running",
      mismatchPercent: "--.---%",
      duration: "7m 30 sec",
    },
    {
      id: "10",
      sNo: 10,
      testName: "PrivacyPolicy",
      timestamp: "12/1/2025 at 9:45 PM",
      status: "In Queue",
      mismatchPercent: "--.---%",
      duration: "--:--",
    },
    {
      ...
      sNo: 11,
      testName: "ContactUs",
      timestamp: "12/1/2025 at 10:00 PM",
      status: "In Queue",
      mismatchPercent: "--.---%",
      duration: "--:--",
    },
    {
      ...
      sNo: 12,
      testName: "FAQ",
      timestamp: "12/1/2025 at 10:15 PM",
      status: "In Queue",
      mismatchPercent: "--.---%",
      duration: "--:--",
    },
    {
      ...
      sNo: 13,
      testName: "Support",
      timestamp: "12/1/2025 at 10:30 PM",
      status: "In Queue",
      mismatchPercent: "--.---%",
      duration: "--:--",
    },
    {
      ...
      sNo: 14,
      testName: "Feedback",
      timestamp: "12/1/2025 at 10:45 PM",
      status: "In Queue",
      mismatchPercent: "--.---%",
      duration: "--:--",
    },
    {
      ...
      sNo: 15,
      testName: "RateApp",
      timestamp: "12/1/2025 at 11:00 PM",
      status: "In Queue",
      mismatchPercent: "--.---%",
      duration: "--:--",
    },
    {
      ...
      sNo: 16,
      testName: "UserGuide",
      timestamp: "12/1/2025 at 11:15 PM",
      status: "In Queue",
      mismatchPercent: "--.---%",
      duration: "--:--",
    },
    {
      id: "17",
      sNo: 17,
      testName: "AccountSettings",
      timestamp: "12/1/2025 at 11:30 PM",
      status: "In Queue",
      mismatchPercent: "--.---%",
      duration: "--:--",
    },
    {
      ...
      sNo: 18,
      testName: "Security",
      timestamp: "12/1/2025 at 11:45 PM",
      status: "In Queue",
      mismatchPercent: "--.---%",
      duration: "--:--",
    },
    {
      id: "19",
      sNo: 19,
      testName: "LanguageSettings",
      timestamp: "12/1/2025 at 11:50 PM",
      status: "In Queue",
      mismatchPercent: "--.---%",
      duration: "--:--",
    },
    {
      ...
      timestamp: "12/1/2025 at 11:55 PM",
      status: "In Queue",
      mismatchPercent: "--.---%",
      duration: "--:--",
    },
    {
      ...
      sNo: 21,
      testName: "AppUpdates",
      timestamp: "12/2/2025 at 12:00 AM",
      status: "In Queue",
      mismatchPercent: "--.---%",
      duration: "--:--",
    },
    {
      id: "22",
      sNo: 22,
      testName: "LogoutConfirmation",
      timestamp: "12/2/2025 at 12:05 AM",
      status: "In Queue",
      mismatchPercent: "--.---%",
      duration: "--:--",
    },
    {
      id: "23",
      sNo: 23,
      testName: "SessionTimeout",
      timestamp: "12/2/2025 at 12:10 AM",
      status: "In Queue",
      mismatchPercent: "--.---%",
      duration: "--:--",
    },
    {
      id: "24",
      sNo: 24,
      testName: "UserFeedback",
      timestamp: "12/2/2025 at 12:15 AM",
      status: "In Queue",
      mismatchPercent: "--.---%",
      duration: "--:--",
    },
    {
      id: "25",
      sNo: 25,
      testName: "VersionHistory",
      timestamp: "12/2/2025 at 12:20 AM",
      status: "In Queue",
      mismatchPercent: "--.---%",
      duration: "--:--",
    },
                ...
                <div className="w-[207px] shrink-0 px-[10px] py-[10px]">
                  {test.status === "PASS" && (
                    <div className="flex items-center gap-[8px] px-[8px] py-0 rounded-[4px]">
                      ...
                      <span className="text-[#05df72] text-[16px] font-mono">
                        PASS
                      </span>
                    </div>
                  )}
                  {test.status === "FAIL" && (
                    <div className="flex items-center gap-[8px] px-[8px] py-0 rounded-[4px]">
                      ...
                      <span className="text-red-500 text-[16px] font-mono">
                        FAIL
                      </span>
                    </div>
                  )}
                  {test.status === "Running" && (
                    <div className="flex items-center gap-[8px] px-[8px] py-0 rounded-[4px]">
                      ...
                      <span className="text-[#3b9eff] text-[16px] font-mono">
                        Running
                      </span>
                    </div>
                  )}
                  {test.status === "In Queue" && (
                    <div className="flex items-center gap-[8px] px-[8px] py-0 rounded-[4px]">
                      ...
                      <span className="text-[#808080] text-[16px] font-mono">
                        In Queue
                      </span>
                    </div>
                  )}
