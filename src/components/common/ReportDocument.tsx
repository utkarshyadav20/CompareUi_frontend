...
export const ReportDocument: React.FC<ReportDocumentProps> = ({
  ...
  break-after: page;
        ...
        .report-legend-item > div:last-child {
          display: flex;
          align-items: center;
        }
    ...
    `}</style>
                ...
                <div className="report-meta-grid">
                    <div className="report-meta-col">
                        ...
                        <div>
                            ...
                            <div className="report-meta-value">{appName || 'No App Name'}</div>
                        </div>
                        <div>
            ...
            <div className="report-card">
                ...
                <div className="report-meta-grid">
                    <div className="label-container" style={{ width: '16%' }}>
                    ...
                    <div className="label-container" style={{ width: '16%' }}>
                        ...
                        <div className="report-meta-value bold">{result.coordinates?.boxes?.length || 0}</div>
                    </div>
                    <div className="label-container" style={{ width: '16%' }}>
                        <div className="report-meta-label">Generated By / Tester</div>
                        <div className="report-meta-value">@Abhijeet Punia</div>
                    </div>
                    <div className="label-container" style={{ width: '16%' }}>
            ...
            <div className="report-card">
                ...
                <div className="issue-box" style={{ fontSize: '14px', lineHeight: '1.5' }}>
            ...
            <div className="report-card">
                ...
                <div className="report-legend" style={{ width: '100%' }}>
                    <div className="report-legend-item" >
                        <div className="report-legend-color" style={{ background: 'var(--major)' }}></div> <div>Major</div>
                    </div>
                    <div className="report-legend-item">
                        <div className="report-legend-color" style={{ background: 'var(--medium)' }}></div> <div>Medium</div>
                    </div>
                    <div className="report-legend-item">
                        <div className="report-legend-color" style={{ background: 'var(--low)' }}></div> <div>Low</div>
                    </div>
                </div>
            </div>
